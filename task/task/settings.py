...
SECRET_KEY = 'django-insecure-62@)z2s19d#xo-q7(e3$%!3upint(3hz7!+h&=1g@$9uo0s92e'
...
CELERY_BEAT_SCHEDULE = {
    'schedule-tasks': {
        'task': 'employees.tasks.schedule_tasks',
        'schedule': 30.0,  # Schedule the task every 30 seconds (adjust as needed)
    },
}
